...
- (id)specifiers
{
    if(_specifiers == nil) {
        ...
        [headerSpecifier setProperty:[NSString stringWithFormat:@"PRZEWARE %@ - %@", [DOEnvironmentManager sharedManager].appVersionDisplayString, DOLocalizedString(@"Menu_Credits_Title")] forKey:@"title"];
    }
    return _specifiers;
}
...
- (void)openSourceCode
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://t.me/ipabrawltap"] options:@{} completionHandler:nil];
}
